...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({ displayName: "App",
	  ...
	  render: function () {
	    return React.createElement("div", { className: "App" }, React.createElement(Chart, {
...
/***/ function(module, exports) {
	...
	d3Chart.create = function (el, props, state) {
	  ...
	  var svg = d3.select(el).append("svg").attr('class', 'd3').attr("width", props.width).attr("height", props.height).append("g").attr("transform", "translate(40,0)");
	  //      .attr('class', 'd3-points');

	  var tree = d3.layout.tree().size([props.height, props.width - 160]);
	  ...
	  var link = svg.selectAll("path.link").data(links).enter().append("path").attr("class", "link").attr("d", diagonal);
